...
**[Download VitalChronicle 1.0.0 for Linux, Windows, or macOS](https://github.com/SebRoLENS/google-health-dashboard-ai/releases/latest)**
...
| Android | Not included in 1.0.0 | Requires a separate mobile UI and OAuth flow |
...
directory name so that upgrading from 0.2.12 to VitalChronicle 1.0.0 preserves existing
