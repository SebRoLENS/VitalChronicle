...
[public issue tracker](https://github.com/SebRoLENS/google-health-dashboard-ai/issues).

## Release trust

Official files are published only through this repository's GitHub Releases. Every
release includes SHA-256 checksums. Linux AppImages are attested through GitHub Actions;
Windows and macOS packages are currently unsigned by paid platform certificates.
