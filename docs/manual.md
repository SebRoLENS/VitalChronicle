...
date: "Updated for VitalChronicle 1.1.8"
lang: en-US
...
This is the authoritative user manual for **VitalChronicle 1.1.8**. VitalChronicle is a
...
existing 0.2.12 archives survive the 1.1.8 upgrade. Typical locations are:
...
VitalChronicle 1.1.8 does not ship an APK. The current application uses desktop Qt widgets,
