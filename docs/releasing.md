...
Updated for VitalChronicle **1.0.5**.
...
1. The release-preparation script keeps `1.0.5` for the first public release and advances
...
as `v1.0.5`. Existing release assets are replaced by filename.
