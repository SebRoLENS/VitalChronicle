...
Updated for VitalChronicle **1.0.8**.
...
1. The release-preparation script keeps `1.0.8` for the first public release and advances
...
as `v1.0.8`. Existing release assets are replaced by filename.
